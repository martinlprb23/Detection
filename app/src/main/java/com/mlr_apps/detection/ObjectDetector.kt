...
/**
 * Caso de uso de análisis de imagen para la detección de objetos de la cámara X
 * @param yuvToRgbConverter Convierta del búfer de imagen YUV_420_888 de la imagen de la cámara al formato RGB
 * @param interpreter tflite Biblioteca para manipular modelos
 * @param labels Lista de etiquetas correctas
 * @param resultViewSize El tamaño de la vista de superficie que muestra los resultados.
 * @param listener Reciba una lista de resultados de análisis en la devolución de llamada
 */
